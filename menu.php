...
<head>
  ...
  <title>BIORECORD - acervo global</title>
  ...
  <header>
    ...
    <div id="nav-container" class="navbar is-success">
      ...
      <div>
        ...
        <button class="button is-info" style="cursor: default;"><strong id="privilegios">Privilégios -
            <?php
      ...
      <div class="card w-50 mb-3" style="width: 18rem">
        ...
        <div>
          ...
          <a class="button is-danger"
            href="acervo_global_excluir.php?id=<?php echo $row['id_publicacao']; ?>">Excluir</a>
        </div>
        <?php
          }
        ?>
